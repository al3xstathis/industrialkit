    ...
    return (
      <button
        ...
        className={cn(
          ...
          "relative",
          // Disable hover/active styles when disabled or loading
          "disabled:hover:bg-inherit disabled:hover:border-inherit disabled:active:bg-inherit",
          // Size variations
          ...
          variant === "default" && [
            ...
            "active:bg-gray-100",
            active && "bg-gray-100",
            // Preserve original background when disabled
          ...
          variant === "primary" && [
            ...
            // Preserve original background when disabled
            "disabled:hover:bg-yellow-400 disabled:hover:border-yellow-400",
          ],
          variant === "danger" && [
            ...
            // Preserve original background when disabled
            "disabled:hover:bg-red-500 disabled:hover:border-red-500",
          ],
          variant === "terminal" && [
            ...
            // Preserve original background when disabled
            "disabled:hover:bg-black disabled:hover:bg-opacity-100",
          ],
          className,
        )}
        {...props}
